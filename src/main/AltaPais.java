 ...
 * @author chenc_000
 */
public class AltaPais extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("exec AltaPais @NombrePais=?");
            ps.setString(1, pais);
            ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaPais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
